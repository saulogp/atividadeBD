...
(
	Codigo smallint identity not null,
...
--Insert 2
 ...
 select * from Linha
insert into Uteis values ('8:00');
insert into Uteis values ('10:00');
insert into Uteis values ('12:00');
insert into Feriado values ('8:20');
insert into Feriado values ('10:20');
insert into Feriado values ('12:20');
insert into Sabado values ('8:30');
insert into Sabado values ('10:30');
insert into Sabado values ('12:30');
insert into Domingo values ('8:40');
insert into Domingo values ('10:40');
insert into Domingo values ('12:40');
insert into Quadro_horario values(2,3,3,3,3);
insert into Quadro_horario values(2,4,4,4,4);
insert into Quadro_horario values(2,5,5,5,5);
insert into Linha (Nome,id_QuadroH) values ('Ch-->Vn',2, );
insert into Logradouro (Nome) values ('Rua Chile');
insert into Logradouro (Nome) values ('Rua Venezuela');
insert into Itinerario (id_Linha, id_Logradouro) values (3,6);
insert into Itinerario (id_Linha, id_Logradouro) values (3,2);
insert into Itinerario (id_Linha, id_Logradouro) values (3,4);
insert into Itinerario (id_Linha, id_Logradouro) values (3,5);
...
from Linha l left join Itinerario i on l.Codigo = i.id_Linha,
Logradouro lg
where l.Nome = 'Ch-->Vn' and lg.Codigo = i.id_Logradouro
order by i.Codigo;
-----------------------------------------------------
--c
select l.Nome, u.Horario as Uteis, f.Horario as Feriado, s.Horario as Sáb, d.Horario as Dom 
...
from Logradouro lg join Itinerario i on i.id_Logradouro = lg.Codigo,
Linha l
where lg.Nome = 'Rua Chile' and i.id_Linha = l.Codigo;
-----------------------------------------------------
